...
```
Luego es necesario tener descargados el modelo y el scorer, disponibles en este [link](https://drive.google.com/drive/folders/1qSXi7vri8UI1P0wMBlbMCnsE1onHnEJH?usp=sharing).
